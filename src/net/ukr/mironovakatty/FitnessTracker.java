...
public class FitnessTracker {
    ...
    public FitnessTracker(String name, String surname, int birthDay, int birthMonth, int birthYear, String email, String phone, double weight, String pressure, int steps) {
        this.name = name;
...
class FitnessTrekkerRunner {
    public static void main(String[] args) {
        ...
        FitnessTracker will = fitnessTrackers[0];
        will.setSurname("Deadshort");
        will.setSteps(11987);
        will.setPressure("140/90");

        FitnessTracker sherlock = fitnessTrackers[2];
